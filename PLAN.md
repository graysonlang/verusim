...
Status: reopened to restore regular handset control surfaces within enlarged hit targets.
...
The final 390×844 handset Chromium pass independently measured 44-pixel interactive bounding boxes and centered 36-pixel padding-box or full-bleed art footprints across the header, transport, day-period, weather, layer, and zoom controls.
