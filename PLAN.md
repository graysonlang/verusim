...
Status: reopened for handset control sizing refinement.
...
- handset presentation keeps scenario identity and essential transport visible in a two-row safe-area-aware header, collapses the layer stack to its active control until opened, and uses 40 CSS pixel handset controls
...
- handset transport retains the normal day-information type size while using 40-pixel controls
